...
function App() {
  return (
    <div className="app">
      <main className="flex flex-col mt-24 md:items-center mx-4">
        <motion.div
          id="intro"
        ...
        <motion.div
          id="projects"
          className="flex flex-col mt-10 gap-5 md:w-[785px]"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 1.5, staggerChildren: 0.2 }}
        >
          ...
          >
            ...
            <div className="flex flex-col justify-between my-5 gap-8">
              ...
              >
                <button className="bg-black text-white rounded-xl py-2 font-bold">
                  View website
                </button>
                <button className="text-black rounded-xl py-2  border-2 border-black font-bold">
                  Look at code
                </button>
              </motion.div>
            </div>
